...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-800 text-white py-8 px-8 min-w-fit">
      <div className="container mx-auto flex justify-between items-center max-sm:px-1 max-md:flex-col-reverse">
        <div className="md:w-2/3 flex justify-between max-md:w-screen max-md:mt-4 max-md:gap-3">
        ...
        <div className="w-1/3 max-md:w-full max-md:px-1">
          ...
          <form className="flex items-center mb-4">
            <input
              ...
              className="bg-gray-700 text-white py-1 px-2 mr-2 rounded"
            />
